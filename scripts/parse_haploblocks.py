...
def main():
	...
	haploblocks_by_sample = Parallel(n_jobs=24)(delayed(parse_haploblocks)(sample) for sample in samples)
	...
	genes_by_haploblock = Parallel(n_jobs=24)(delayed(evaluate_gene_haploblocks)(sample) for sample in samples)
